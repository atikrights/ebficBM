...
class AssetModel {
  ...
  factory AssetModel.fromMap(Map<String, dynamic> map) {
    return AssetModel(
      ...
      isCompressed: _parseBool(map['isCompressed'] ?? false),
      isDeleted: _parseBool(map['isDeleted'] ?? false),
    );
  }
  ...
  factory AssetModel.fromBackend(Map<String, dynamic> map) {
    ...
    return AssetModel(
      ...
      url: map['url'],
      uploadDate: map['created_at'] != null ? DateTime.parse(map['created_at']) : DateTime.now(),
    );
  }
}
