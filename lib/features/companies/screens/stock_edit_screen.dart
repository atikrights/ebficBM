...
class _StockEditScreenState extends State<StockEditScreen> {
  ...
  Future<void> _save() async {
    ...
    try {
      await Provider.of<CompanyStockProvider>(context, listen: false)
          .updateStock(widget.stock.companyId, updated);
  ...
  Future<void> _delete() async {
    ...
    try {
      await Provider.of<CompanyStockProvider>(context, listen: false)
          .deleteStock(widget.stock.companyId, widget.stock.id);
