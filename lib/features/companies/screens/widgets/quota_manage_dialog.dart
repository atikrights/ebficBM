...
class QuotaManageDialog extends StatefulWidget {
  final Function(String title, String tag) onSave;

  const QuotaManageDialog({
    Key? key,
    required this.onSave,
  }) : super(key: key);

  @override
  State<QuotaManageDialog> createState() => _QuotaManageDialogState();
}

class _QuotaManageDialogState extends State<QuotaManageDialog> {
