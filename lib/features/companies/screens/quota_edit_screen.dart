...
class QuotaEditScreen extends StatefulWidget {
  ...
  @override
  State<QuotaEditScreen> createState() => _QuotaEditScreenState();
}

class _QuotaEditScreenState extends State<QuotaEditScreen> {
  ...
  Future<void> _save() async {
    ...
    try {
      await Provider.of<CompanyExternalQuotaProvider>(context, listen: false)
          .updateQuota(widget.quota.companyId, updated);
  ...
  Future<void> _delete() async {
    ...
    try {
      await Provider.of<CompanyExternalQuotaProvider>(context, listen: false)
          .deleteQuota(widget.quota.companyId, widget.quota.id);
