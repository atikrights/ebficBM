...
import 'database_vault_screen.dart';
    ...
    Widget sidebarContent = AnimatedContainer(
      ...
      child: Column(
        children: [
          ...
          _sidebarItem(context, IconsaxPlusLinear.driver, "Database Vault", 5, isExpanded, isDrawer: isDrawer, color: AdminTheme.accent),
          const Spacer(),
